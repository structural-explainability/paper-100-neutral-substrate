...
\begin{description}[style=nextline,leftmargin=1.5cm]
  ...
  \item[Boundary Condition]
        ...
        entity identity and persistence conditions are invariant
        across admissible frameworks in the domain.
  ...
  \item[Commitment]
        A proposition asserted by an ontology as holding at the substrate layer,
  ...
  \item[Substrate]
        ...
        \emph{substrate}.
        A neutral substrate excludes causal and normative primitives from the foundational layer,
