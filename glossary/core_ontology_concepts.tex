...
\begin{description}[style=nextline,leftmargin=1.5cm]
  ...
  \item[Boundary Condition]
        ...
        entity identity and persistence conditions must be invariant
        across admissible frameworks within the domain.
        Domains where identity is itself contested
        do not admit neutral substrates in the sense defined in this paper.
  ...
  \item[Identity Conditions]
        ...
        Identity conditions govern individuation
        within the ontology.

  \item[Identity-and-Persistence Regime]
        A structured set of identity and persistence conditions
        governing how a class of entities is individuated and tracked
        ...
        In a neutral substrate, such regimes provide the identity and persistence structure
        upon which interpretive frameworks operate.

  \item[Level of Abstraction (LoA)]
        A perspective defined by a specific set of predicate symbols
        used to represent a domain.
        The LoA determines what can be represented or queried;
        selecting a restricted LoA excludes
        certain predicates from the ontology's vocabulary.
  ...
  \item[Ontological Primitive]
        ...
        restricted to those governing entity identity
        and persistence conditions, while
        causal and normative predicates are excluded
  ...
  \item[Vocabulary]
        ...
        At a given LoA, the vocabulary determines
