...
\begin{description}[style=nextline,leftmargin=1.5cm]
  ...
  \item[Accountability System]
        ...
        and assignment of responsibility across multiple stakeholders or interpretive perspectives.
  ...
  \item[Externalization]
        ...
        ontologies provide alternative implementation strategies.
        See \emph{Reification}.

  \item[Framework-Contestable Proposition]
        A proposition whose truth value may be evaluated differently
        by admissible interpretive frameworks.
        Framework-contestable propositions arise when the assessment
        of a claim depends on causal models or normative standards
        applied to the same underlying entities and events.
        In a neutral substrate, such propositions may not be asserted
        as substrate-layer commitments and must instead be represented
        within interpretive frameworks.
        See also \emph{Framework-Variant Proposition}.

  \item[Framework-Invariant Referential Structure]
        Elements of the substrate's vocabulary whose interpretation
        remains constant across admissible interpretive frameworks.
        In this paper, framework-invariant referential structure
        consists of predicate symbols governing entity identity
        and persistence conditions.
        Such predicates may appear as substrate-layer commitments
        because their interpretation does not depend on a particular
        interpretive framework.
        Contrast with \emph{Framework-Variant Proposition}.

  \item[Framework-Variant Proposition]
        A proposition whose truth value may differ across admissible
        interpretive frameworks.
        Framework-variant propositions may not appear as substrate-layer
        commitments under the neutrality definition.
        Formally defined in Definition~\ref{def:framework-variant}.
  ...
  \item[Interpretive Non-Commitment]
        The requirement that a substrate refrain from asserting
        causal or normative conclusions as substrate-layer commitments,
        since their truth may vary across admissible interpretive frameworks.
        An ontology satisfies interpretive non-commitment
        if it does not commit the substrate to conclusions
        whose truth depends on a particular interpretive framework.
  ...
  \item[Pluralism]
        ...
        commit the substrate to any single framework.
