...
under incompatible extensions, is incompatible with asserting
causal or normative commitments at the substrate layer.
Any ontology that asserts causal or normative conclusions
at the substrate layer cannot serve as a neutral substrate across divergent
...
for any system intended to maintain a shared and
stable representation across conflicting interpretive frameworks.
\end{abstract}
...
\emph{Let $\mathcal{O}$ be an ontology intended to function
  ...
  does not assert causal or normative conclusions
  as substrate-layer ontological facts.}

\medskip
\noindent
Informally: Neutrality is not achieved by
identifying universally accepted causes or norms,
but by refraining from asserting causal or normative conclusions
at the substrate level.
A neutral ontology must remain pre-causal and pre-normative
at its foundational layer, while allowing causal and normative
interpretations to be represented in extension layers.
