...
are incompatible with asserting causal or normative conclusions
...
of a causal relation or normative conclusion as a substrate-layer fact
(e.g., that event $A$ caused event $B$, or that an action constituted a violation),
rather than the representation of such claims as interpretive assertions or reports.
...
there exist admissible interpretive frameworks that affirm
the claim and others that reject it.
For commitments whose truth depends on causal or normative interpretation,
admissible frameworks may legitimately disagree about whether the claim holds.
...
\medskip
\textbf{(If.)}
Suppose $\mathcal{S}$ refrains from asserting causal and normative commitments
