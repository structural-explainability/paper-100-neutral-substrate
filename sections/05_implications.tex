...
\begin{itemize}
  \item normative commitments, such as
        ...
        evaluative judgments that privilege one legal, political, or
        analytic stance over others;
  \item causal commitments, such
        as assertions
...
the substrate fixes a set of \textit{framework-invariant referential structures}:
predicate symbols governing entity existence,
identity, and persistence conditions that remain constant regardless
of the explanatory logic applied to them.

The claim that a neutral substrate relies on framework-invariant referential structure
