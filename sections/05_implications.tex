...
\begin{itemize}
  \item normative commitments, such as obligations, permissions, prohibitions, violations, or compliance determinations;
  \item causal commitments, such as assertions that one event caused, produced, or was responsible for another;
  \item evaluative commitments, such as judgments that privilege one legal, political, or analytic stance over others.
\end{itemize}
...
\begin{itemize}
  \item restrict the foundational LoA to
        framework-invariant observables:
