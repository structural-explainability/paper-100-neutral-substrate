...
\centering
\noindent
\textbf{Conceptual Architecture of Neutral Substrates}
...
(asserted propositions about shared referents) \\
$\uparrow$ \\
Neutral Substrate \\
(constraints on foundational commitments) \\
$\uparrow$ \\
Shared Referents \\
(entities, events, institutional artifacts)
\end{tabular}
...
In the next section, we establish the central impossibility result
