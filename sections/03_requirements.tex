...
The neutrality requirements introduced in this section
operate across several conceptual layers.
Logical propositions provide the basic contents of representation.
Ontologies assert some propositions as commitments.
Interpretive frameworks reason over those commitments and
derive conclusions about events, responsibilities, or explanations.
A neutral substrate constrains which propositions may be asserted
as ontological commitments so that multiple frameworks
may derive incompatible conclusions without forcing revision of the substrate.
