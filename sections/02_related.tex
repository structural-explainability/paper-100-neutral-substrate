...
The central result formalizes this accommodation
as a structural constraint on substrate-layer commitments.
...
of embedding interpretive commitments at the substrate layer,
...
These frameworks may be extended in practice
...
In Floridi's terms, while BFO and DOLCE provide
...
Legal ontologies, e.g., the Legal Knowledge Interchange Format
...
Rather, it observes that causal conclusions are framework-dependent
in the same structural sense as normative conclusions,
as formalized subsequently in Lemma~\ref{lem:contestability}.
When treated as substrate commitments,
causal relations commit the ontology to a particular causal model.
For neutral substrates, causal reasoning is therefore located
in interpretive layers where model assumptions are explicit
...
In ontological terms, these observables correspond to the predicate symbols
available in the system's representational vocabulary.
...
Under this view, neutrality is a function of
operating at a foundational LoO
with a deliberately restricted LoA.
This paper extends Floridi's work by proving
that causal and normative predicates
cannot be asserted at the substrate layer
without violating neutrality under extension by
...
The theorem specifies what cannot be shared
...
This observation is consistent with the present result by illustrating
...
the formal constraints such accommodation must satisfy.
...
the present result clarifies why neutrality constraints must apply
to the latter even as the former necessarily change.

By grounding this constraint in the Method of Levels of Abstraction,
the debate shifts from a sociological discussion of agreement
